...
/// Cabecera verde con curva convexa y foto circular.
        ...
        child: Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: AppColors.goldAccent.withValues(alpha: 0.6), width: 3),
              boxShadow: [
                BoxShadow(
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: UnderlineInputBorder(
              borderSide:
                  BorderSide(color: cs.primary.withValues(alpha: 0.5), width: 1.4),
            ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.offlineRed.withValues(alpha: 0.35)),
      ),
      child: Row(
        children: [
